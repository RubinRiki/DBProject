...
-- Started on 2025-05-26 10:28:55
...
--
-- TOC entry 2171 (class 1417 OID 57626)
...
--
-- TOC entry 3338 (class 2604 OID 66019)
...
--
-- TOC entry 3549 (class 0 OID 40961)
-- Dependencies: 218
...
--
-- TOC entry 3550 (class 0 OID 40964)
-- Dependencies: 219
...
--
-- TOC entry 3561 (class 0 OID 65921)
-- Dependencies: 238
...
--
-- TOC entry 3569 (class 0 OID 66016)
-- Dependencies: 246
...
--
-- TOC entry 3551 (class 0 OID 40967)
-- Dependencies: 220
...
1.5	222	Riesling	2024-11-25	655	\N
...
--
-- TOC entry 3559 (class 0 OID 41052)
-- Dependencies: 228
...
--
-- TOC entry 3552 (class 0 OID 40970)
-- Dependencies: 221
...
--
-- TOC entry 3553 (class 0 OID 40973)
-- Dependencies: 222
-- Data for Name: materials_; Type: TABLE DATA; Schema: public; Owner: riki
--

COPY public.materials_ (materialid_, name_, supplierid_, quantityavailable_, purchesid) FROM stdin;
6	yeast	880133468	73.32	\N
7	sorbate\t	974486834	512.04	\N
8	acid	953896930	374.76	\N
9	filter	144301605	19.71	\N
10	gloves	987389467	387.44	\N
1	bottle\t	981402913	897.19	\N
2	cork\t	208634251	919.72	\N
3	label\t	572814245	409.40999999999997	\N
4	cleaner\t	829758960	557.17	\N
5	rinse\t	361346674	405.1	\N
\.


--
-- TOC entry 3565 (class 0 OID 65941)
-- Dependencies: 242
...
--
-- TOC entry 3570 (class 0 OID 74072)
-- Dependencies: 247
...
--
-- TOC entry 3564 (class 0 OID 65936)
-- Dependencies: 241
...
--
-- TOC entry 3554 (class 0 OID 40976)
-- Dependencies: 223
...
--
-- TOC entry 3555 (class 0 OID 40979)
-- Dependencies: 224
...
--
-- TOC entry 3556 (class 0 OID 40982)
-- Dependencies: 225
...
--
-- TOC entry 3563 (class 0 OID 65931)
-- Dependencies: 240
-- Data for Name: product_local; Type: TABLE DATA; Schema: public; Owner: riki
--

COPY public.product_local (productid, productname, price, brand, stockquantity) FROM stdin;
1	מיץ גזר	37.00	גבע	28
2	צהובה	33.00	זוהר	62
3	מאפה בצל	50.00	מאפיית ישן	27
4	עוגה	15.00	אחוה	188
5	שמנת חמוצה	18.00	אלטרנטיבה	70
6	סלטים	30.00	אדום חם	79
7	חומוס יבש	31.00	רמי לוי	199
8	פיתות עיראקיות	41.00	דודו	111
9	תפוחי אדמה	15.00	ביסי	100
10	הדס	16.00	ההום	179
11	פתיתים	6.00	גבעי	79
12	קוטג דל שומן	32.00	יטבתה	14
13	פול	22.00	קוסמו	193
14	שיפון מלא	26.00	מאפיית תמר	172
15	חלב	47.00	אלטרנטיבה	29
16	לחם אגוזים	10.00	אחוה	27
17	טוסט	11.00	מאפיית ישן	130
18	קפיר	30.00	אביב	26
19	חטיף שוקולד	35.00	חפלה	129
20	חטיף תירס	6.00	חפלה	137
21	לחם קרואסון	32.00	דודו	149
22	מיץ אננס	24.00	פריגת	67
23	מיץ תפוזים	42.00	קוקה	171
24	עכסים	38.00	גבעי	36
25	דיאט קולה	46.00	זוהר	46
26	פופקורן	11.00	כרמית	170
27	חלב בטעמים	41.00	יטבתה	114
28	קפיר	11.00	נבלום	59
29	חטיף תירס	29.00	הדר	80
30	מוצרלה	40.00	אלטרנטיבה	17
31	אפונה	19.00	אדום חם	155
32	ספרייט	50.00	נסטי	179
33	במבה	36.00	רגליה	127
34	צהובה	8.00	טרה	167
35	מים טהורים	22.00	נקש	50
36	סוכריות	25.00	הדר	91
37	פיתות עיראקיות	19.00	מאפיית תמר	194
38	פלאפל	17.00	ההום	143
39	יוגורט פרי	43.00	הכפר	17
40	פלאפל	45.00	וילי	157
41	מלפפונים	7.00	ההום	151
42	קטניות חלב	28.00	שופרסל	112
43	מיץ ענבים	11.00	קוקה	189
44	לחם חלום	41.00	אחוה	16
45	במבה קלאסי	45.00	אסם	58
46	לחם	14.00	מאפיית רפאל	135
47	עוגה	41.00	פיתות רונן	70
48	טורטית	10.00	רויאל	198
49	פטריות	45.00	אדום חם	156
50	פיתות זעתר	19.00	ברמן	174
51	מיץ לימון	45.00	קוקה	141
52	תפוחי אדמה	26.00	סוגת	92
53	מסקרפונה	13.00	נבלום	40
54	טורטית	46.00	הדר	112
55	יוגורט פירות	22.00	זוהר	156
56	גריסים	10.00	שופרסל	184
57	אפונה	14.00	דוש	180
58	שעועית ירוקה	41.00	דוש	172
59	גריסים	29.00	סוגת	112
60	שוקולד חלב	38.00	קונצרט	10
61	מיץ לימון	7.00	נסטי	79
62	כוסמת	37.00	המטוס	117
63	פיתות סבתא	34.00	מאפיית ישן	117
64	בירה לאלפיים	25.00	גבע	47
65	קרמבו	32.00	קונצרט	121
66	הדס	11.00	יכין	179
67	מים טהורים	25.00	גבע	146
68	מיץ קיווי	34.00	נענע	110
69	חומוס	49.00	רמי לוי	30
70	טונה	15.00	דוש	58
71	שיפון מלא	45.00	אנגל	134
72	ספגטי	37.00	יכין	26
73	פלאפל	45.00	סוגת	57
74	פטריות	12.00	שופרסל	74
75	לחם	31.00	פיתות רונן	35
76	מיץ אננס	42.00	קוקה	36
77	גבינה	20.00	אביב	59
78	פטה	33.00	נבלום	39
79	פיצה פריזאית	32.00	דודו	71
80	מיץ אפרסק	16.00	נענע	111
81	צהובה	49.00	יטבתה	197
82	קינואה	46.00	רמי לוי	101
83	תפוזים	8.00	נסטי	113
84	עדשים	31.00	הגיבעתי	143
85	חומוס טחינה	28.00	וילי	167
86	פתיתים	48.00	סוגת	143
87	בגט	36.00	מאפיית א.ר.	171
88	חטיף חלווה	14.00	טווינקס	180
89	פול חום	10.00	הגיבעתי	47
90	סוכריות	37.00	טווינקס	53
91	שיפון מלא	7.00	מאפיית א.ר.	184
92	נסטי	26.00	זוהר	182
93	קרמבו	43.00	רגליה	87
94	מיץ קיווי	37.00	יפאורה	98
95	גריסים	15.00	הגיבעתי	95
96	לחם שומשום	43.00	פיתות רונן	105
97	רסק	5.00	ההום	122
98	חלב בטעמים	12.00	גד	63
99	בורגול	42.00	רמי לוי	56
100	מיץ תפוזים	42.00	ספרינג	196
101	חטיף שוקולד	45.00	אסם	22
102	לחם	20.00	דודו	94
103	יוגורט	49.00	תנובה	26
104	פיצה פריזאית	29.00	מאפיית רפאל	70
105	אורז בר	44.00	סוגת	92
106	מים מוגזים	49.00	קימח	193
107	בגט	41.00	לייזר	194
108	ביסקוויטים	39.00	מטה	34
109	שמנת מתוקה	20.00	אביב	97
110	קוסקוס מלא	14.00	קוסמו	197
111	שמנת מתוקה	16.00	אלטרנטיבה	157
112	ספרייט	11.00	נקש	49
113	רסק אמצעי	18.00	רמי לוי	83
114	יוגורט	47.00	יטבתה	199
115	מיץ לימון	32.00	זוהר	158
116	ספגטי	28.00	ההום	48
117	לחם חלום	43.00	מאפיית רפאל	112
118	תפוחים ירוקים	7.00	המטוס	35
119	פלאפל	40.00	שירן	43
120	פיצוחים	20.00	קונצרט	188
121	חומוס טחינה	9.00	שופרסל	49
122	בורגול	29.00	גבעי	36
123	ספגטי	50.00	דוש	193
124	חלב שקדים	49.00	אלטרנטיבה	183
125	פירות חתוכים	15.00	שירן	156
126	חומוס יבש	39.00	קוסמו	62
127	תירס	42.00	סיוול	32
128	ביסקוויטים	7.00	עלית	134
129	חטיף שוקולד	34.00	עלית	141
130	חטיף תירס	34.00	אסם	125
131	יוגורט טבעי	5.00	גד	106
132	במבה	46.00	טווינקס	126
133	במבה קלאסי	48.00	קונצרט	121
134	פסק זמן	17.00	קונצרט	124
135	תירס	33.00	ביסי	147
136	בורגול	10.00	ביסי	56
137	סלטים	32.00	דוש	108
138	חטיף חמאה	14.00	חפלה	135
139	שעועית ירוקה	32.00	סוגת	65
140	יוגורט פירות	7.00	טרה	71
141	מיץ תפוזים	12.00	נענע	132
142	עוגה	13.00	מאפיית ישן	179
143	הדס	17.00	וילי	178
144	סוכריות גומי	46.00	רגליה	53
145	פיתות זעתר	27.00	מאפיית דבורה	150
146	מסקרפונה	33.00	אלטרנטיבה	82
147	חלב עיזים	40.00	זוהר	186
148	תפוחים ירוקים	16.00	עוקב	61
149	תירס	40.00	קוסמו	152
150	שמנת	9.00	זוהר	64
151	קוטג 5%	27.00	יטבתה	56
152	קרמל מלוח	40.00	רגליה	181
153	לחם אגוזים	30.00	מאפיית תמר	34
154	במבה קלאסי	27.00	רויאל	30
155	קטניות חלב	40.00	רמי לוי	135
156	חומוס טחינה	28.00	דוש	19
157	פטריות	19.00	שירן	19
158	מיני שוקולד	22.00	כרמית	182
159	תירס	49.00	דוש	35
160	לחם כוסמין	48.00	אנגל	94
161	ממרח טחינה	23.00	אדום חם	49
162	קרמל מלוח	32.00	אסם	16
163	סרדינים	5.00	אדום חם	198
164	עכסים	35.00	המטוס	177
165	פול	40.00	רמי לוי	60
166	לחם גרעינים	37.00	מאפיית א.ר.	200
167	מוצרלה	43.00	יטבתה	113
168	שעועית ירוקה	27.00	רמי לוי	120
169	מיץ תפוחים	9.00	נענע	112
170	מיץ ענבים	27.00	פריגת	92
171	יוגורט טבעי	21.00	תנובה	43
172	לחם עם זיתים	6.00	אחוה	117
173	פירות חתוכים	48.00	שופרסל	18
174	מיץ דובדבן	12.00	זוהר	53
175	רסק אמצעי	25.00	שירן	176
176	תפוא מוקרמים	6.00	שופרסל	28
177	במבה קלאסי	45.00	הדר	69
178	פלאפל	39.00	דוש	89
179	קפה קר	35.00	נסטי	80
180	תפוחי אדמה	6.00	דוש	200
181	קרמבו	8.00	מטה	136
182	בורגול דק	17.00	המטוס	189
183	קוטג 5%	50.00	הכפר	45
184	שימורי פירות	35.00	יכין	28
185	פתיתים	19.00	הגיבעתי	53
186	ביסלי	32.00	קונצרט	136
187	פיצוחים	39.00	מטה	107
188	זיתים	25.00	שופרסל	45
189	שעועית	8.00	רמי לוי	165
190	פסטה	15.00	שופרסל	139
191	סודה	19.00	זוהר	137
192	קוטג 5%	26.00	זוהר	182
193	תירס	6.00	פריניב	51
194	שמנת מתוקה	11.00	תנובה	164
195	שמנת 38%	42.00	זוהר	180
196	מיצים טבעיים	9.00	גבע	64
197	כיף כף	25.00	רויאל	132
198	לחמניות	44.00	מאפיית רפאל	21
199	שימורי פירות	48.00	שירן	13
200	כוסמת	32.00	גבעי	54
201	פסטה אגוזית	8.00	רמי לוי	160
202	מלפפונים	30.00	רמי לוי	18
203	חטיף גרנולה	32.00	קונצרט	128
204	תפוא מוקרמים	7.00	שירן	144
205	פסטה פיקנטית	13.00	יכין	65
206	לחם שומשום	46.00	מאפיית ישן	124
207	קרמבו	30.00	כרמית	39
208	כוסמת	47.00	עוקב	27
209	תפוחי אדמה	10.00	סיוול	143
210	מאפה בורשט	47.00	ברמן	51
211	קוסקוס	44.00	סוגת	143
212	פיתות זעתר	23.00	מאפיית ישן	50
213	ספרייט	46.00	יפאורה	28
214	לחם מלא	26.00	לייזר	108
215	מיץ רימונים	8.00	נקש	24
216	משקה אנרגיה	21.00	גבע	170
217	יוגורט טבעי	48.00	הכפר	136
218	פיתות סבתא	48.00	אחוה	85
219	עוגיות	9.00	מטה	125
220	חלב שקדים	6.00	הכפר	34
221	קוטג דל שומן	50.00	גד	25
222	עוגיות	11.00	קונצרט	95
223	שמנת 38%	35.00	שטראוס	100
224	שעועית	23.00	אדום חם	76
225	פירות חתוכים	40.00	אדום חם	155
226	חלב	28.00	הכפר	106
227	חטיף חלווה	5.00	קונצרט	92
228	בגט	10.00	מאפיית ישן	54
229	חלב בטעמים	28.00	טרה	65
230	רסק עגבניות	23.00	יכין	123
231	מיץ דובדבן	37.00	גבע	134
232	אורז בר	31.00	קוסמו	38
233	לחם מלא	30.00	מאפיית דבורה	44
234	לחם עם זיתים	46.00	לייזר	128
235	לחמניות	6.00	מאפיית א.ר.	73
236	קפיר	49.00	גד	107
237	מאפה בורשט	22.00	מאפיית רפאל	173
238	מיץ לימון	21.00	נקש	54
239	פסטה אגוזית	15.00	קוסמו	122
240	קוטג 5%	41.00	גד	175
241	חטיף מלוח	15.00	קונצרט	128
242	במבה קלאסי	26.00	חפלה	117
243	מסקרפונה	42.00	שטראוס	189
244	לחם קרואסון	26.00	מאפיית תמר	77
245	מסקרפונה	8.00	גד	11
246	חומוס	50.00	שופרסל	61
247	שתייה מוגזת	17.00	פריגת	37
248	מיץ אבטיח	10.00	קוקה	43
249	סלט ירקות	31.00	ההום	78
250	חמצוצים	29.00	הדר	131
251	רסק	14.00	וילי	121
252	קפה קר	31.00	גבע	139
253	ספרייט	42.00	זוהר	98
254	חלב סויה	18.00	יטבתה	83
255	שיפון מלא	46.00	פיתות רונן	43
256	קרואסון	42.00	אנגל	53
257	חטיף תירס	12.00	קונצרט	196
258	תירס	6.00	וילי	156
259	קוסקוס מלא	34.00	הגיבעתי	22
260	חטיף תירס	5.00	מטה	38
261	קפה קר	6.00	קוקה	48
262	ריוויון	22.00	יטבתה	71
263	קמח תפוּח	17.00	המטוס	85
264	בירה לאלפיים	40.00	ספרינג	19
265	רבע לשבע	15.00	הדר	40
266	כיף כף	45.00	חפלה	197
267	רסק עגבניות	20.00	שירן	102
268	מים	47.00	ספרינג	96
269	משקה אנרגיה	32.00	נסטי	165
270	גריסים	15.00	סיוול	65
271	טוסט	13.00	לייזר	199
272	בורקס	35.00	מאפיית ישן	165
273	פסק זמן	40.00	חפלה	178
274	סלט ירקות	10.00	יכין	136
275	לחם גרעינים	9.00	אחוה	68
276	תפוא מוקרמים	26.00	אדום חם	60
277	בורגול	35.00	שופרסל	156
278	קפה קר	47.00	פריגת	66
279	חומוס יבש	23.00	הגיבעתי	152
280	יוגורט פירות	50.00	גד	19
281	קפה קר	18.00	יפאורה	67
282	תירס מתוק	41.00	סוגת	119
283	חלב שקדים	20.00	זוהר	28
284	מיץ גזר	49.00	נסטי	68
285	מסטיקים	48.00	הדר	177
286	הדס	17.00	פריניב	86
287	מיץ אננס	42.00	נענע	19
288	יוגורט פירות	47.00	אביב	143
289	ריוויון	29.00	שטראוס	168
290	לחם	20.00	מאפיית דבורה	166
291	מסקרפונה	39.00	זוהר	195
292	מסקרפונה	44.00	הכפר	24
293	שתייה מוגזת	8.00	נסטי	81
294	פול חום	41.00	קוסמו	75
295	משקה אנרגיה	25.00	פריגת	59
296	פיתות	20.00	מאפיית רפאל	147
297	פיתות עיראקיות	23.00	לייזר	110
298	פיצה פריזאית	49.00	אחוה	161
299	לחם כוסמין	36.00	לייזר	159
300	ניסקו	23.00	יפאורה	166
301	שמנת שמנת	31.00	אלטרנטיבה	193
302	יוגורט פירות	15.00	שטראוס	57
303	מיץ תפוחים	37.00	זוהר	177
304	לחם חלום	10.00	לייזר	70
305	פיתה	27.00	מאפיית דבורה	69
306	באגט מרוקאי	42.00	לייזר	16
307	תפוחי אדמה	7.00	גבעי	81
308	פול	23.00	שופרסל	31
309	קוטג דל שומן	44.00	אלטרנטיבה	176
310	פיתות	12.00	לייזר	196
311	במבה	48.00	עלית	18
312	מיץ תפוזים	21.00	נסטי	195
313	שמנת	48.00	אלטרנטיבה	113
314	לחם שומשום	30.00	לייזר	185
315	שמנת חמוצה	49.00	הכפר	84
316	פיתות עיראקיות	33.00	אחוה	46
317	עכסים	40.00	הגיבעתי	92
318	פופקורן	14.00	רויאל	85
319	תירס	47.00	רמי לוי	31
320	חומוס יבש	22.00	עוקב	83
321	פיתה	10.00	מאפיית תמר	169
322	עדשים	41.00	עוקב	92
323	לחם שומשום	6.00	ברמן	90
324	עוגיות	34.00	כרמית	50
325	סוכריות	23.00	קונצרט	125
326	עדשים	44.00	קוסמו	200
327	יוגורט דל שומן	8.00	נבלום	179
328	בורקס	42.00	אחוה	117
329	פתיתים	46.00	ביסי	71
330	פיתה	22.00	ברמן	151
331	מיץ לימון	35.00	נענע	113
332	חמאה	48.00	זוהר	68
333	תירס מתוק	27.00	קוסמו	75
334	חטיף חמאה	50.00	טווינקס	28
335	פלאפל	27.00	אדום חם	22
336	שמנת שמנת	39.00	שטראוס	33
337	רסק אמצעי	10.00	ההום	43
338	חטיף גרנולה	26.00	אסם	101
339	פירות חתוכים	45.00	רמי לוי	154
340	יוגורט פרי	23.00	תנובה	63
341	זיתים	48.00	אדום חם	120
342	סוכריות	44.00	כרמית	13
343	לחם עם זיתים	10.00	דודו	181
344	סלט ירקות	18.00	רמי לוי	71
345	קרואסון	16.00	ברמן	193
346	ניסקו	17.00	ספרינג	57
347	חטיף סויה	8.00	מטה	43
348	שיפון מלא	47.00	מאפיית ישן	26
349	פטריות טריות	25.00	דוש	185
350	טונה	8.00	ההום	101
351	קולה	18.00	נקש	89
352	חומוס טחינה	31.00	סוגת	112
353	ניסקו	46.00	קימח	61
354	מיץ ענבים	40.00	זוהר	79
355	ניסקו	47.00	פריגת	170
356	שוקולד	44.00	קונצרט	113
357	מיץ תפוזים	41.00	נקש	28
358	קוטג 5%	30.00	תנובה	100
359	לחמניות	46.00	אנגל	29
360	פול חום	18.00	המטוס	186
361	לחם עם זיתים	40.00	מאפיית ישן	49
362	במבה	32.00	חפלה	137
363	יוגורט	19.00	אביב	48
364	חטיף סויה	14.00	חפלה	60
365	פול חום	46.00	סוגת	74
366	בורקס	16.00	מאפיית רפאל	70
367	בורקס	42.00	דודו	32
368	חלב	5.00	נבלום	126
369	פיתות עיראקיות	18.00	פיתות רונן	179
370	קוסקוס מלא	5.00	המטוס	130
371	מאפה בורשט	38.00	פיתות רונן	30
372	מיץ מנגו	46.00	פריגת	139
373	מסטיקים	6.00	מטה	25
374	חומוס	40.00	פריניב	155
375	מאפה קינמון	16.00	מאפיית דבורה	53
376	אורז	18.00	רמי לוי	59
377	משקה אנרגיה	7.00	זוהר	60
378	מיצים טבעיים	29.00	נקש	199
379	מיץ תפוחים	6.00	פריגת	24
380	מלפפונים	24.00	פריניב	196
381	מיץ מנגו	27.00	קימח	140
382	פסק זמן	35.00	רגליה	80
383	עדשים	27.00	סוגת	126
384	פיתה	48.00	דודו	90
385	שמנת חמוצה	32.00	נבלום	118
386	לחם עם זיתים	46.00	מאפיית תמר	60
387	פיתות זעתר	25.00	אנגל	92
388	לחם שומשום	8.00	מאפיית תמר	65
389	חלב בטעמים	28.00	שטראוס	148
390	תירס	15.00	גבעי	154
391	פול חום	5.00	שופרסל	125
392	חלב	17.00	אביב	57
393	פטריות טריות	22.00	אדום חם	102
394	חטיף גרנולה	29.00	הדר	196
395	עדשים	43.00	ביסי	141
396	סוכריות	10.00	אסם	165
397	תירס מתוק	8.00	גבעי	34
398	לחם כוסמין	40.00	אחוה	43
399	חלב סויה	7.00	הכפר	63
400	לחם שיפון	6.00	לייזר	124
401	Barbera	32.50	Modernet	100
402	Dolcetto	28.00	Modernet	120
403	Gamay	29.90	Modernet	90
404	Malbec	33.00	Modernet	110
405	Merlot	31.00	Modernet	80
406	Pinot Noir	35.50	Modernet	95
407	Riesling	30.00	Modernet	105
408	Syrah	34.00	Modernet	115
\.


--
-- TOC entry 3557 (class 0 OID 40985)
-- Dependencies: 226
...
--
-- TOC entry 3558 (class 0 OID 40988)
-- Dependencies: 227
...
--
-- TOC entry 3566 (class 0 OID 65944)
-- Dependencies: 243
...
--
-- TOC entry 3567 (class 0 OID 65949)
-- Dependencies: 244
...
--
-- TOC entry 3560 (class 0 OID 65916)
-- Dependencies: 237
...
--
-- TOC entry 3562 (class 0 OID 65926)
-- Dependencies: 239
...
--
-- TOC entry 3341 (class 2606 OID 40992)
...
--
-- TOC entry 3367 (class 2606 OID 65925)
...
--
-- TOC entry 3377 (class 2606 OID 66023)
...
--
-- TOC entry 3343 (class 2606 OID 40994)
...
--
-- TOC entry 3345 (class 2606 OID 40996)
...
--
-- TOC entry 3347 (class 2606 OID 74056)
...
--
-- TOC entry 3363 (class 2606 OID 41058)
...
--
-- TOC entry 3349 (class 2606 OID 40998)
...
--
-- TOC entry 3351 (class 2606 OID 41000)
...
--
-- TOC entry 3379 (class 2606 OID 74076)
...
--
-- TOC entry 3373 (class 2606 OID 65940)
...
--
-- TOC entry 3353 (class 2606 OID 41002)
...
--
-- TOC entry 3355 (class 2606 OID 41004)
...
--
-- TOC entry 3357 (class 2606 OID 41006)
...
--
-- TOC entry 3371 (class 2606 OID 65935)
...
--
-- TOC entry 3359 (class 2606 OID 41008)
...
--
-- TOC entry 3361 (class 2606 OID 41010)
...
--
-- TOC entry 3375 (class 2606 OID 65948)
...
--
-- TOC entry 3365 (class 2606 OID 65920)
...
--
-- TOC entry 3369 (class 2606 OID 65930)
...
--
-- TOC entry 3399 (class 2606 OID 66024)
...
--
-- TOC entry 3387 (class 2606 OID 41060)
...
--
-- TOC entry 3391 (class 2606 OID 65952)
...
--
-- TOC entry 3380 (class 2606 OID 74057)
...
--
-- TOC entry 3393 (class 2606 OID 65962)
...
--
-- TOC entry 3394 (class 2606 OID 65967)
...
--
-- TOC entry 3392 (class 2606 OID 65957)
...
--
-- TOC entry 3395 (class 2606 OID 74036)
...
--
-- TOC entry 3397 (class 2606 OID 65982)
...
--
-- TOC entry 3398 (class 2606 OID 65977)
...
--
-- TOC entry 3400 (class 2606 OID 74082)
...
--
-- TOC entry 3401 (class 2606 OID 74077)
...
--
-- TOC entry 3382 (class 2606 OID 41016)
...
--
-- TOC entry 3383 (class 2606 OID 41021)
...
--
-- TOC entry 3384 (class 2606 OID 41026)
...
--
-- TOC entry 3385 (class 2606 OID 41031)
...
--
-- TOC entry 3386 (class 2606 OID 41036)
...
--
-- TOC entry 3388 (class 2606 OID 41041)
...
--
-- TOC entry 3389 (class 2606 OID 74050)
...
--
-- TOC entry 3390 (class 2606 OID 41046)
...
--
-- TOC entry 3396 (class 2606 OID 74045)
...
-- Completed on 2025-05-26 10:28:55
